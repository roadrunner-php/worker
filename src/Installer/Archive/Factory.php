...
class Factory implements FactoryInterface
{
     ...
     * @return \Closure
     */
    private function extensionMatcher(string $extension, \Closure $then): \Closure
    {
