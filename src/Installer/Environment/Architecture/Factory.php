...
namespace Spiral\RoadRunner\Installer\Environment\Architecture;

use JetBrains\PhpStorm\ExpectedValues;
use Spiral\RoadRunner\Installer\Environment\Architecture;
use Spiral\RoadRunner\Installer\Environment\EnvironmentAwareTrait;
...
class Factory
{
    ...
    {
        $uname = $this->env($variables, static::ENV_PROCESSOR_ARCHITECTURE, \php_uname('m'));
